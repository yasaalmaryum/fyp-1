  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={4} onClick={() => navigate("/form")}>
          <Item>
        ...
        <Grid item xs={4} onClick={() => navigate("/create")}>
          <Item>
            <Image
        ...
        <Grid item xs={4} onClick={() => navigate("/generate")}>
          <Item>
            <Image
        ...
        <Grid item xs={4}onClick={() => navigate("/history")}>
          <Item>
            <Image
        ...
        <Grid item xs={4} onClick={() => navigate("/faculty")}>
          <Item>
            <Image
