...
export default function CourseDrop() {
  ...
  const handleFormSubmit = (e) => {
    ...
    const coursesToDrop = tableData.map((course) => ({
      course_number: 121, // Ensure this is an integer
    ...
    axios
      ...
      .then((res) => {
        toast("Course Drop Application Submitted Successful", {
          type: "success",
        });
      })
      .catch((error) => {
    ...
    // axios
    //   .get(URLS.listTeachers, { headers: headers })
    //   .then((res) => {
    //     console.log("got teachers", res.data);
    //     // toast("Course Drop Successful", {
    //     //   type: "success",
    //     // });
    //   })
    //   .catch((error) => {
      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="body2" sx={{ textAlign: "center" }}>
            ...
            This application needs to be verified by the Class Counselor,
            Department DCO, recommended by HOD in order to be approved. The
            Efficient DigiDocs will keep you informed about the application
            status. You can check the Track Application Page by entering your
            application ID.
          </Typography>
        </CardContent>
      </Card>
